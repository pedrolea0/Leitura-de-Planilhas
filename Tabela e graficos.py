...
#display(tabela) # basicamente um print
...
ptc_idade = tabela["Inatividade 12m"].value_counts(normalize=True).round(2)

#display (ptc_categoria, ptc_idade)
...
#   #grafico.show() #.show pra mostrar o grafico
#   fig.write_html("grafico.html")


# escreve os graficos em um arquivo html
